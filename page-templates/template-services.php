        ...
        <div class="site-container">
            ...
            <div class="page-services-icon-grid">
                <div class="front-why-choose__box card-border fade-in fade-in-delay-1">
                    ...
                    <a href="<?php echo esc_url( home_url( '/services/revenue-management/' ) ); ?>" class="btn btn--ghost"><?php esc_html_e( 'Learn more', '360-hotelier' ); ?></a>
                </div>
                ...
                <div class="front-why-choose__box card-border fade-in fade-in-delay-2">
                    ...
                    <a href="<?php echo esc_url( home_url( '/services/online-sales-distribution/' ) ); ?>" class="btn btn--ghost"><?php esc_html_e( 'Learn more', '360-hotelier' ); ?></a>
                </div>
                ...
                <div class="front-why-choose__box card-border fade-in fade-in-delay-3">
                    ...
                    <a href="<?php echo esc_url( home_url( '/services/digital-marketing/' ) ); ?>" class="btn btn--ghost"><?php esc_html_e( 'Learn more', '360-hotelier' ); ?></a>
                </div>
                ...
                <div class="front-why-choose__box card-border fade-in fade-in-delay-4">
                    ...
                    <a href="<?php echo esc_url( home_url( '/services/tour-operator-contracting/' ) ); ?>" class="btn btn--ghost"><?php esc_html_e( 'Learn more', '360-hotelier' ); ?></a>
                </div>
            </div>
        </div>
    </section>
