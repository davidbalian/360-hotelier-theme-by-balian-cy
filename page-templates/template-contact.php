...
$page_hero_tagline  = __( "Grow Your Hotel's Revenue & Distribution.", '360-hotelier' );
$page_hero_subtitle = __( "Tell us about your property. We'll identify where the revenue opportunity is.", '360-hotelier' );
...
<main id="main" class="site-main page-contact">
    ...
    <section class="front-featured-banner card-border" style="background-image: url('<?php echo esc_url( content_url( '/uploads/2026/03/featured-360-hotelier.webp' ) ); ?>');">
        ...
        <div class="site-container front-featured-banner__content fade-in fade-in-delay-0">
            ...
            <p class="front-featured-banner__text"><?php esc_html_e( "Tell us about your hotel. We'll show you where the revenue opportunity is — no cost, no commitment.", '360-hotelier' ); ?></p>
