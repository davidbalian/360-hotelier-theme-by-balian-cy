    ...
    <div class="site-container">
        ...
        <div class="front-results__ticker">
            <div class="front-results__ticker-track">
                ...
                <img src="<?php echo esc_url( content_url( '/uploads/2026/03/tsanotel-hd-logo.webp' ) ); ?>" alt="<?php esc_attr_e( 'Tsanotel Cyprus', '360-hotelier' ); ?>" loading="lazy" aria-hidden="true" />
