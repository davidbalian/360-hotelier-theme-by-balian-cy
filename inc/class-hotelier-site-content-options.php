 ...
 */
	...
	/** @var string Absolute path to generated sync file (merged into defaults()). */
	public const SYNC_FILE_RELATIVE = '/inc/hotelier-db-defaults.sync.php';
	...
	/**
	 * Built-in defaults only (no generated sync file). Used by the sync script and defaults().
	 *
	...
	/**
	 * Overrides from inc/hotelier-db-defaults.sync.php (regenerated by CLI).
	 *
	 * @return array<string, mixed>
	 */
	private static function synced_site_content_overrides(): array {
		...
		/** @var mixed $data */
		$data = require $path;
		if ( ! is_array( $data ) || ! isset( $data['site_content'] ) || ! is_array( $data['site_content'] ) ) {
			return array();
		}
	...
	public static function defaults(): array {
		return array_merge( self::builtin_defaults(), self::synced_site_content_overrides() );
	}
