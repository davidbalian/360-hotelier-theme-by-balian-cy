...
return array(
	...
	'hero_bg'                => array(
		...
		'default_url' => $u . 'cyprus-hotel-revenue-consulting.webp',
	),
	...
	'svc_1_img'              => array( 'type' => 'image', 'label' => 'Service card 1 — image', 'default_url' => $u . 'hotel-revenue-management-strategy.webp' ),
	...
	'svc_2_img'              => array( 'type' => 'image', 'label' => 'Service card 2 — image', 'default_url' => $u . 'hotel-online-sales-distribution-strategy.webp' ),
	...
	'svc_3_img'              => array( 'type' => 'image', 'label' => 'Service card 3 — image', 'default_url' => $u . 'hotel-digital-marketing-direct-bookings.webp' ),
	...
	'svc_4_img'              => array( 'type' => 'image', 'label' => 'Service card 4 — image', 'default_url' => $u . 'hotel-tour-operator-contracting-negotiations.webp' ),
	...
	'results_tick_7_alt'     => array( 'type' => 'text', 'label' => 'Results ticker — logo 7 alt', 'default' => 'MITO Seaview Paphos' ),
	...
	'approach_1_img'         => array( 'type' => 'image', 'label' => 'Step 1 — image (above number)', 'default_url' => $u . 'hotel-digital-marketing-direct-bookings-1.webp' ),
	'approach_1_img_alt'     => array( 'type' => 'text', 'label' => 'Step 1 — image alt', 'default' => 'Audit & Insights' ),
	...
	'approach_2_img'         => array( 'type' => 'image', 'label' => 'Step 2 — image (above number)', 'default_url' => $u . 'hotel-online-sales-distribution-strategy-1.webp' ),
	'approach_2_img_alt'     => array( 'type' => 'text', 'label' => 'Step 2 — image alt', 'default' => 'Strategy & Planning' ),
	...
	'approach_3_img'         => array( 'type' => 'image', 'label' => 'Step 3 — image (above number)', 'default_url' => $u . 'hotel-revenue-management-strategy-cyprus.webp' ),
	'approach_3_img_alt'     => array( 'type' => 'text', 'label' => 'Step 3 — image alt', 'default' => 'Execution & Management' ),
	...
	'approach_4_img'         => array( 'type' => 'image', 'label' => 'Step 4 — image (above number)', 'default_url' => $u . 'hotel-tour-operator-contracting-negotiations-1.webp' ),
	'approach_4_img_alt'     => array( 'type' => 'text', 'label' => 'Step 4 — image alt', 'default' => 'Review & Optimization' ),
	'approach_cta_text'      => array( 'type' => 'text', 'label' => 'How we work — CTA', 'default' => 'Book a Free Consultation' ),

	'feat_img'               => array( 'type' => 'image', 'label' => 'Featured banner — image', 'default_url' => $u . 'book-hotel-consulting-services-cyprus-360hotelier.webp' ),
