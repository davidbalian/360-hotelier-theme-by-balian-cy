...
if ( ! defined( 'HOTELIER_PORTFOLIO_HOTEL_COUNT' ) ) {
	define( 'HOTELIER_PORTFOLIO_HOTEL_COUNT', 10 );
}
...
$defaults = array(
	...
	'intro_h2'              => array( 'type' => 'text', 'label' => 'Intro — heading', 'default' => 'Our Portfolio' ),
	'intro_p1'              => array(
		'type'    => 'textarea',
		'label'   => 'Intro — paragraph 1',
		'default' => 'At 360° Hotelier Consulting, we collaborate with independent, boutique and resort hotels in Cyprus, providing revenue management, online sales & B2B distribution, digital marketing and tour-operator contracting services.',
	),
	'intro_p2'              => array(
		'type'    => 'textarea',
		'label'   => 'Intro — paragraph 2',
		'default' => 'Our portfolio reflects hands-on partnerships where we have helped hotels increase revenue, optimise channel performance, grow direct bookings and secure stronger commercial agreements.',
	),
	'intro_p3'              => array(
		'type'    => 'textarea',
		'label'   => 'Intro — paragraph 3',
		'default' => "Each project is tailored to the hotel's market positioning, seasonality and commercial goals - delivering measurable results through data-driven hotel consulting and strategic execution.",
	),
	'intro_side_img'        => array( 'type' => 'image', 'label' => 'Intro — side image', 'default_url' => content_url( '/uploads/2026/04/bottom-cta-4.jpg' ) ),
...
$out['hotel_3_url']['default']       = 'https://serbellashotel.com/';
...
$out['hotel_6_name']['default']      = 'TSANotel';
$out['hotel_6_location']['default']  = 'Limassol, Cyprus';
$out['hotel_6_url']['default']       = 'https://www.tsanotel.com/';
$out['hotel_6_logo']['default_url']  = $u . 'tsanotel-hd-logo.webp';
$out['hotel_6_photo']['default_url'] = $u . 'tsanotel-limassol-hotel-revenue-management.webp';
$out['hotel_6_alt']['default']       = 'Tsanotel Cyprus';

$out['hotel_7_name']['default']      = 'Pendeli Resort';
$out['hotel_7_location']['default']  = 'Platres, Cyprus';
$out['hotel_7_url']['default']       = 'https://www.pendeliresort.com/';
$out['hotel_7_mode']['default']      = 'pendeli';
$out['hotel_7_logo']['default_url']  = '';
$out['hotel_7_photo']['default_url'] = $u . 'pendeli-resort-platres-hotel-consulting.webp';

$out['hotel_8_name']['default']      = 'Petit Palais Platres Boutique Hotel';
$out['hotel_8_location']['default']  = 'Platres, Cyprus';
$out['hotel_8_url']['default']       = 'https://www.petitpalais.com.cy/';
$out['hotel_8_logo']['default_url']  = $u . 'petit-palais-platres-hotel-logo-color-cyprus.webp';
$out['hotel_8_photo']['default_url'] = $u . 'petit-palais-platres-boutique-hotel-consulting.webp';
$out['hotel_8_alt']['default']       = 'Petit Palais Hotel Platres Cyprus';

$out['hotel_9_name']['default']      = 'Napa Jay Hotel';
$out['hotel_9_location']['default']  = 'Ayia Napa, Cyprus';
$out['hotel_9_url']['default']       = 'https://napajayhotel.com/';
$out['hotel_9_logo']['default_url']  = $u . 'napa-jay-hotel-logo-cropped.png';
$out['hotel_9_photo']['default_url'] = $u . 'napa-jay-hotel-ayia-napa-hotel-consulting.webp';
$out['hotel_9_alt']['default']       = 'Napa Jay Hotel Ayia Napa Cyprus';

$out['hotel_10_name']['default']      = 'Chic Centre Suites Athens';
$out['hotel_10_location']['default']  = 'Athens, Greece';
$out['hotel_10_url']['default']       = 'https://chiccentresuites.com/';
$out['hotel_10_logo']['default_url']  = $u . 'chic-centre-suites-athens-hotel-logo.webp';
$out['hotel_10_photo']['default_url'] = $u . 'chic-centre-suites-athens-hotel-consulting-project.webp';
$out['hotel_10_alt']['default']       = 'Chic Centre Suites Athens';
...
$out['hotel_4_tagline']['default']  = 'Premier beachfront resort in Limassol, with stunning sea views, fine dining, and world-class marina facilities.';
$out['hotel_5_tagline']['default']  = 'Luxury seaside living in Limassol with elegant residences, panoramic Mediterranean views, and exclusive marina access.';
$out['hotel_6_tagline']['default']  = 'Hotel in Limassol\'s vibrant tourist area with modern comforts.';
$out['hotel_7_tagline']['default']  = 'Iconic historical mountain resort in Platres surrounded by scenic beauty.';
$out['hotel_8_tagline']['default']  = 'Charming historical boutique hotel in Platres with cozy elegance.';
$out['hotel_9_tagline']['default']  = 'Affordable hotel near Ayia Napa\'s top attractions and nightlife.';
$out['hotel_10_tagline']['default'] = 'Stylish city-centre suites in Athens, Greece\'s capital, ideal for urban stays.';
