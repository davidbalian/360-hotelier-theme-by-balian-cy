...
final class Hotelier_El_Page_Defaults {
	...
	private static function load_map(): array {
		return array(
			...
			'portfolio.intro_p2'          => 'Το portfolio μας αντικατοπτρίζει ουσιαστικές συνεργασίες όπου έχουμε βοηθήσει ξενοδοχεία να αυξήσουν τα έσοδά τους, να βελτιστοποιήσουν την απόδοση των καναλιών πώλησης, να ενισχύσουν τις απευθείας κρατήσεις και να εξασφαλίσουν ισχυρότερες εμπορικές συμφωνίες.',
			'portfolio.intro_p3'          => 'Κάθε έργο προσαρμόζεται στη θέση του ξενοδοχείου στην αγορά, την εποχικότητα και τους εμπορικούς του στόχους, προσφέροντας μετρήσιμα αποτελέσματα μέσα από στρατηγικές βασισμένες σε δεδομένα και πρακτική εφαρμογή hotel consulting.',
			...
			'portfolio.hotel_4_tagline'   => 'Κορυφαίο παραλιακό θέρετρο στη Λεμεσό με εκπληκτική θέα στη θάλασσα, εκλεκτή γαστρονομία και μαρίνα παγκόσμιας κλάσης.',
			'portfolio.hotel_5_tagline'   => 'Πολυτελής παραλιακή διαμονή στη Λεμεσό με κομψές κατοικίες, πανοραμική θέα στη Μεσόγειο και αποκλειστική πρόσβαση στη μαρίνα.',
			'portfolio.hotel_6_tagline'   => 'Ξενοδοχείο στη ζωντανή τουριστική περιοχή της Λεμεσού με σύγχρονες ανέσεις.',
			'portfolio.hotel_7_tagline'   => 'Εμβληματικό ιστορικό ορεινό θέρετρο στις Πλάτρες, περιτριγυρισμένο από μοναδική φυσική ομορφιά.',
			'portfolio.hotel_8_tagline'   => 'Γοητευτικό ιστορικό boutique ξενοδοχείο στις Πλάτρες με ζεστή κομψότητα.',
			'portfolio.hotel_9_tagline'   => 'Προσιτό ξενοδοχείο κοντά στα κορυφαία αξιοθέατα και τη νυχτερινή ζωή της Αγίας Νάπας.',
			'portfolio.hotel_10_tagline'  => 'Κομψές σουίτες στο κέντρο της Αθήνας, πρωτεύουσας της Ελλάδας, ιδανικές για αστικές διαμονές.',
