...
function hotelier_output_schema() {
    $schema = array(
        ...
        'url'         => home_url( '/' ),
        'image'       => has_custom_logo() ? wp_get_attachment_image_url( get_theme_mod( 'custom_logo' ), 'full' ) : home_url( '/wp-content/uploads/2026/03/360-hotelier-horizontal-logo.webp' ),
        'priceRange'  => '$$',
